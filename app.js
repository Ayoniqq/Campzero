...
const PORT = process.env.PORT || 7238; //7238 is default for Railway app;
...
app.get('/fakeUser', async (req, res) => {
    const user = new User({ email: 'johndoe@getMaxListeners.com', username: 'johndoe99' });
...
//Mongo Atlas Pswd: XDlypTu7UChIU4qY
